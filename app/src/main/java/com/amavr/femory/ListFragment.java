...
public class ListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adpItems = new ItemsAdapter(this.getContext(), XMem.getInstance().getItems());
        DividerItemDecoration itemDecor = new DividerItemDecoration(getContext(), DividerItemDecoration.HORIZONTAL);
        rvItems.addItemDecoration(itemDecor);
        rvItems.setAdapter(adpItems);
